...
$mailto = 'jendy@andrewdyck.com'; // Enter your mail addres here. 
$subject = 'Wedding website response'; // Enter the subject here.
...
$song = stripcslashes($_POST['song']);
$attend = stripcslashes($_POST['attend']);
$allergy = stripcslashes($_POST['allergy']);
/*$headers = "From: $name <$emailAddr>" . "\r\n" . "Reply-To: $emailAddr" . "\r\n" . "X-Mailer: PHP/" . phpversion();*/
$headers = "From: $name <jendy@andrewdyck.com>";

$guest = stripcslashes($_POST['guest']);


$message = 
	  "Name: " . $name 
	. "\nE-mail address: " . $emailAddr
	. "\nSong: " . $song
	. "\nAttendance: " . $attend
	. "\nAllergies: " . $allergy
	. "\nMessage: " . $msg
